...
export const BASE_URL = getOptionalEnvVar("VITE_API_URL") ?? BACKEND_BASE_URL;
export const ACCESS_TOKEN_KEY = getOptionalEnvVar("VITE_ACCESS_TOKEN_KEY") ?? "accessToken";
export const REFRESH_TOKEN_KEY = getOptionalEnvVar("VITE_REFRESH_TOKEN_KEY") ?? "refreshToken";
